...
def convert_bab_ii():
    ...
    create_word_document(
        ...
        content,
        "vrp_rl_project/BAB_II_TINJAUAN_PUSTAKA_FINAL.docx"
    )
...
def convert_bab_iii():
    ...
    create_word_document(
        ...
        content,
        "vrp_rl_project/BAB_III_METODOLOGI_PENELITIAN_FINAL.docx"
    )
...
def convert_bab_iv():
    ...
    create_word_document(
        ...
        content,
        "vrp_rl_project/BAB_IV_HASIL_DAN_PEMBAHASAN_FINAL.docx"
    )

def main():
    print("🔄 CONVERTING MARKDOWN TO WORD FORMAT (FINAL VERSION)")
    print("=" * 60)
    ...
    try:
        ...
        print("=" * 60)
        print("📁 Files created:")
        print("   - BAB_II_TINJAUAN_PUSTAKA_FINAL.docx")
        print("   - BAB_III_METODOLOGI_PENELITIAN_FINAL.docx")
        print("   - BAB_IV_HASIL_DAN_PEMBAHASAN_FINAL.docx")
        print("\n✨ Features:")
        print("   ✅ Bold text properly formatted")
        print("   ✅ Times New Roman font throughout")
        print("   ✅ Proper list formatting")
        print("   ✅ Mathematical calculations in BAB III")
        print("   ✅ Detailed DQN parameters")
        print("\n📋 Next Steps:")
        print("   1. Open the _FINAL.docx files in Microsoft Word")
        print("   2. Review formatting - should be perfect now!")
